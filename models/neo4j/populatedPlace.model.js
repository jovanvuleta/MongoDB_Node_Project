    ...
    return {
        ...
        addPopulatedPlace: (stateId, id, name, pttCode) => {
            return new Promise((resolve, reject) => {
                ...
                let query = 'MATCH(s:STATE {DR_IDENTIFIKATOR: $stateId}) MERGE (c:CITY {cityId: $id, name: $name, zip: $pttCode}) MERGE ((c) - [r:BELONGS_TO] -> (s)) RETURN s, c, r';
        ...
        editPopulatedPlaceById: (stateId, newId, name, pttCode, id) => {
            return new Promise((resolve, reject) => {
                ...
                let query = 'MATCH(s:STATE {DR_IDENTIFIKATOR : $stateId}) MERGE(c:CITY {cityId : $id}) ON CREATE SET c.cityId = $newId, c.name = $name, c.zip = $pttCode ON MATCH SET c.cityId = $newId, c.name = $name, c.zip = $pttCode MERGE((c)-[r:BELONGS_TO]->(s)) RETURN s, c, r'
